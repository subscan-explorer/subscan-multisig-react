...
function createTesting(t, firstOnly, withSort) {
  return (0, _util.expandEndpoints)(
    t,
    [
      ...
      {
        info: 'dolphin',
        text: t('rpc.dolphin', 'Dolphin Testnet', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'interbtc',
        text: t('rpc.test.interbtc', 'Interlay', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'phala',
        text: t('rpc.test.phala', 'Khala (Para3)', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'kilt',
        text: t('rpc.test.kilt.mash', 'KILT Mashnet', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'kilt',
        text: t('rpc.test.kilt.pere', 'KILT Peregrine', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'neumann',
        text: t('rpc.test.oak', 'Neumann Network', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'opal',
        text: t('opal.unique.network', 'OPAL by UNIQUE', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'polymesh',
        text: t('rpc.test.polymesh', 'Polymesh Testnet', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'sherpax',
        text: t('rpc.test.sherpax', 'Sherpax Testnet', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      {
        info: 'subdao',
        text: t('rpc.test.subdao', 'SubDAO Staging', {
          ns: 'apps-config',
        }),
        providers: {
