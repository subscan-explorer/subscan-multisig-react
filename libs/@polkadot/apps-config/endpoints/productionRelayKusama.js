  ...
  return {
    ...
    linked: [
      ...
      },
      {
        ...
        isUnreachable: true,
        // https://github.com/polkadot-js/apps/issues/6794
        paraId: 2105,
        text: t('rpc.kusama.crab', 'Darwinia Crab', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      },
      {
        ...
        paraId: 2102,
        text: t('rpc.kusama.pichiu', 'Pichiu', {
          ns: 'apps-config',
        }),
        providers: {
      ...
      },
      {
        info: 'subsocial',
        isUnreachable: true,
        // https://github.com/polkadot-js/apps/issues/6550
        homepage: 'https://subsocial.network/',
        paraId: 2100,
        text: t('rpc.kusama.subsocial', 'Subsocial', {
          ns: 'apps-config',
        }),
        providers: {
