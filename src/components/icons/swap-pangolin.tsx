...
function Swap() {
  return (
    <svg width="1em" height="1em" viewBox="0 0 22 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <filter id="filter-1">
          <feColorMatrix
            in="SourceGraphic"
      ...
      <g id="DVM" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="其他网络" transform="translate(-216.000000, -304.000000)">
          <g id="1.通用/2.Icon图标/Line/Change" transform="translate(215.000000, 301.000000)" filter="url(#filter-1)">
            <g>
              <rect id="矩形" fill="#000000" fillRule="nonzero" opacity="0" x="0" y="0" width="24" height="24"></rect>
              <path
